          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50 text-[10px] uppercase font-black text-slate-400 tracking-[0.2em]">
                <th className="px-8 py-5 border-b border-slate-100">Assignment</th>
                <th className="px-8 py-5 border-b border-slate-100">Status</th>
                <th className="px-8 py-5 border-b border-slate-100">Level</th>
                <th className="px-8 py-5 border-b border-slate-100">Drafted</th>
              </tr>
            </thead>
